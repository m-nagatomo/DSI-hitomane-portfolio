...
- 上記のいずれにも該当しないインスタレーション作品について、以下の割合判定を行う：
  - 評価対象作品（アプリケーションデザインと自主制作イラストを除くすべての作品）のうち、公的発表・受賞歴のないインスタレーション作品が40%以上を占める場合 → デザイン構築力を1寄りに評価する
  - 40%未満の場合 → インスタレーション作品の割合を理由に評価を下げない
