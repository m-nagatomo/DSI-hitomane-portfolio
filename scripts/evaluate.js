    ...
    messages: [
      {
        ...
        content: [
          ...
          {
            type: 'text',
            text: `このポートフォリオを以下の3項目で厳格に評価してください。各項目を1〜4の4段階で採点し、スコアが3以上の場合はどのような点が優れているかを日本語で具体的にコメントしてください。
...
【スコア基準（厳格に適用すること）】
1 = 不十分：明らかな欠如や根本的な問題がある
2 = 標準以下：基本的なことはできているが、それ以上の質・深みがない。平均的な水準に達していない
3 = 良い：明確な独自性・論理性・完成度があり、本当に優れていると判断できる場合のみ
4 = 非常に優れている：極めて高い水準で、強く印象に残る卓越した質がある場合のみ

※ スコア3以上は稀であるべきです。「悪くない」「普通にできている」はすべて2以下です。

【論理的思考力の評価軸】
- 「ワクワク」「キラキラ」など感覚的・抽象的な表現のみで論理的根拠が薄い場合は低く評価する
- コンセプト設計において自己中心的な視点のみで、体験者・ユーザー視点が欠けている場合は低く評価する
- 課題定義→仮説→解決策の思考プロセスが明確でない場合は低く評価する

【デザイン構築力の評価軸】
- 図面やプロセスが形式的に揃っているだけで斬新さや独自性がない場合は低く評価する
- 制作物に独自の工夫・創意が感じられない場合は低く評価する
- プランニングの質・実現可能性・論理的な設計思考が伴っている場合のみ高く評価する

【ビジュアルデザインの評価軸】
- 文字が大きく文字数が少ない、思考の浅さが見える構成は低く評価する
- 全体的に洗練されていない・子供っぽいデザインは低く評価する
- 余白・フォント・色彩・レイアウトが整っており、プロフェッショナルな完成度がある場合のみ高く評価する
