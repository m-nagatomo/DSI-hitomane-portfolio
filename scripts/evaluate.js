...
【デザイン構築力】
まず以下を判定してからスコア基準を選択すること：
- ポートフォリオ内の空間デザイン作品（住宅・店舗・公共空間・オフィスなど）の数を数える
- 「グループ制作」と明記されているもののみをグループ制作としてカウントする。「グループ展」は個人制作の可能性があるためグループ制作としてカウントしない
- グループ制作作品が全体に占める割合を確認する

▼ グループ制作作品が全体の3割以上を占める場合：
- デザインへの意欲が低いと判断し、スコアは1とする
...
▼ 空間デザイン作品が2つ以下の場合（プロダクト・アート系の可能性が高い）：
個人制作のプロダクト作品の数と説明ページの充実度を重視して評価する。
さらに、時計・椅子・照明器具など機能的なプロダクト作品が3つ以上含まれている場合は、実用的なものをデザインする力があると判断し、下記スコアを1段階上げる方向で考慮する（ただし上限は3）。機能的なプロダクト作品が3つ未満の場合は評価を上げない。
